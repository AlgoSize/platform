    ...
    steps:
      ...
      - name: Comment and gate
        ...
        env:
          ...
          LOWER:    \${{ steps.run.outputs.lower_usd }}
          UPPER:    \${{ steps.run.outputs.upper_usd }}
